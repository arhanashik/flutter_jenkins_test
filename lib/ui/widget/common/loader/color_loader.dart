/// Created by mdhasnain on 21 Mar, 2020
...
class ColorLoader extends StatefulWidget {
  ...
  ColorLoader({
    this.colors = const [
      Colors.red, Colors.green, Colors.indigo, Colors.pinkAccent, Colors.blue
    ],
...
class _ColorLoaderState extends State<ColorLoader>
  ...
  void initState() {
    ...
    tweenAnimations.add(
        ColorTween(begin: colors[colors.length - 1], end: colors[0])
    );
